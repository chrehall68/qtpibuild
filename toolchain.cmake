...
set(TARGET_SYSROOT /home/eliot/rpi-sysroot/)
...
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} --sysroot=${TARGET_SYSROOT} --target=aarch64-linux-gnu -mcpu=cortex-a53")
set(CMAKE_CXX_FLAGS "${CMAKE_C_FLAGS}")

set(QT_COMPILER_FLAGS "-march=armv8-a")
set(QT_COMPILER_FLAGS_RELEASE "-O3 -pipe")
set(QT_LINKER_FLAGS "-Wl,-O3 -Wl,--hash-style=gnu -Wl,--as-needed")
